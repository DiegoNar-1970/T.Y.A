...
import { FormContract } from './components/formContract/formContract/FormContract.jsx'
      ...
      <div id='app' className='app  h-screen p-2 gap-2 bg-[#f5f5f7]'>
        ...
        <main className='[grid-area:main] sm:w-full rounded-[18px] p-2 overflow-y-auto'> 
          ...
          <Routes>
              ...
              <Route path='contratos/formularioContrato/:contrato' element={<FormContract/>}></Route>
              <Route path='/*'></Route>
          </Routes>
        </main>
        <footer 
