          ...
          <Text style={styles.text}>
            {demandantes.map((demandante, index) => (
              <React.Fragment key={index}>
                <Text style={styles.bold}>{demandante.name.toUpperCase()}</Text>, mayor y vecina/o de esta ciudad,
                identificada con {demandante.type_of_doc} N° <Text style={styles.bold}>{demandante.document}</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            prestar asesoría jurídica en todo momento al mandante en los siguientes asuntos: {''}
             {constTypeContract===constTypeContract.LEGAL_SERVICES ? 'Demanda juzgado civil':'Juzgado civil municipal'} en contra de{' '}
            {demandados.map((demandado, index) => (
              <React.Fragment key={index}>
                <Text style={styles.bold}>{demandado.name.toUpperCase()}</Text> con NIT <Text style={styles.bold}>{demandado.type_of_doc}</Text>{' '}
                <Text style={styles.bold}>{demandado.document}</Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.signatureSection, { marginTop: 10 }]}>
          <View style={styles.signatureBlock}>
            ...
            {demandantes.map((demandante, index) => (
              <React.Fragment key={index}>
                <Text style={[styles.text, styles.bold]}>{demandante.name.toUpperCase()}</Text>
